...
本目录用于录入预设的装备、道具、技能、关系列表、初始剧情和预定义伙伴头像数据，方便不懂代码的人员维护。
...
1. 直接编辑数据文件
   - 打开 `baseInfo.json`、`equipments.json`、`items.json`、`skills.json`、`partners.json`、`backgrounds.json`、`predefined-avatars.json`
   - 按照格式添加或修改数据
   - 可以自由添加注释来说明数据用途
